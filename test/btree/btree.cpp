...
class Run() {
	...
	*/
	   ...
	   printf("Length of initial segment matching %d\n", comp );
		...
		{
			BTreeDataWstring::Insert((ulong)4,(char*)"EFGH",(ulong)4,(char*)"ABCD");
...
class BTreeDataWstring
{
	public:
	void Insert(ulong size, char* ID, ulong size_value, char* value)//no
	{
	...
	printf("dt %p\n",dt);
		...
		last->next=((void*)dt-(void*)this->buffer-header->data);
